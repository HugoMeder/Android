package de.bitsnarts.camerasnapshot.obsolete;
...
import de.bitsnarts.camerasnapshot.R;

public class MainActivityObsolete extends AppCompatActivity implements ServiceListener, TextureView.SurfaceTextureListener {
...
*/
    ...
    public void checkPermission(String permission, int requestCode)
    {
        ...
        if (ContextCompat.checkSelfPermission(
            ...
            Toast
                    .makeText(MainActivityObsolete.this,
